 ...
 const socialLinks = [
  ...
  },
  {
    ...
    return (
        ...
        >
            <div className="relative z-10 flex flex-col-reverse md:flex-row   justify-around items-center mx-auto h-full md:px-4 ">
                ...
                <div className=" md:flex w-full md:w-1/2 justify-center items-center mt-5 pt-5 Md:mb-8 md:mb-0">
                    <img
                        src="/web.png"
